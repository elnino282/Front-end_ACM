...
import { useAllFarmerHarvests, useCreateHarvest, useDeleteHarvest, type Harvest as ApiHarvest } from '@/entities/harvest';
...
import { GRADE_DISTRIBUTION_COLORS, GRADE_POINTS_MAP, PLANNED_YIELD } from "../constants";
...
export function useHarvestManagement() {
    ...
    const { data: apiData, isLoading: apiLoading, error: apiError, refetch } = useAllFarmerHarvests(harvestParams);
    ...
    }, [formData, mutationSeasonId, createMutation]);
    ...
    return {
        effectiveSeasonId, hasSeasonContext: !!seasonContext,
